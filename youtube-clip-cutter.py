...
#     st.session_state.download_progress_bar = st.progress(0)  # Initialize the progress bar here
#     ydl_opts = {
...
#         else:
#             st.session_state.download_progress = 0.0  # Handle division by zero
#         st.session_state.download_progress_bar.progress(st.session_state.download_progress)
#     else:
#         st.session_state.download_progress = 0.0  # Default value
#         st.session_state.download_progress_bar.progress(st.session_state.download_progress)
