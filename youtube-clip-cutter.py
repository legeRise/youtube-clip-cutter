...
# Threading lock to prevent concurrent downloads/trims
download_lock = Lock()

# Function to download video using yt-dlp
def download_video(url):
    with download_lock:  # Ensure only one download happens at a time
...
# Function to trim the video (stream directly to ffmpeg)
